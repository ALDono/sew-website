...
const productsJson = JSON.parse(products);
      ...
      /////////////////////
        ...
        document.getElementById("1710358274685").addEventListener("click",function(){
          let id = this.id;
          initialisePrev(id,2)
        })

        document.getElementById("1710358430761").addEventListener("click",function(){
          let id = this.id;
          initialisePrev(id,3)
        })

        document.getElementById("1710358499994").addEventListener("click",function(){
          let id = this.id;
          initialisePrev(id,4)
        })

        document.getElementById("1710358536734").addEventListener("click",function(){
          let id = this.id;
          initialisePrev(id,5)
        })
...
(function () {
  ...
  function ShopifyBuyInit() {
    ...
    ShopifyBuy.UI.onReady(client).then(function (ui) {
      ui.createComponent('product', {
        id: '8776901329230',
        node: document.getElementById('product-component-1710358274685'),
        moneyFormat: '%C2%A3%7B%7Bamount%7D%7D',
        options: {
  "product": {
    "styles": {
...
(function () {
  ...
  function ShopifyBuyInit() {
    ...
    ShopifyBuy.UI.onReady(client).then(function (ui) {
      ui.createComponent('product', {
        id: '8776901624142',
        node: document.getElementById('product-component-1710358430761'),
        moneyFormat: '%C2%A3%7B%7Bamount%7D%7D',
        options: {
  "product": {
    "styles": {
...
(function () {
  ...
  function ShopifyBuyInit() {
    ...
    ShopifyBuy.UI.onReady(client).then(function (ui) {
      ui.createComponent('product', {
        id: '8776902312270',
        node: document.getElementById('product-component-1710358499994'),
        moneyFormat: '%C2%A3%7B%7Bamount%7D%7D',
        options: {
  "product": {
    "styles": {
...
(function () {
  ...
  function ShopifyBuyInit() {
    ...
    ShopifyBuy.UI.onReady(client).then(function (ui) {
      ui.createComponent('product', {
        id: '8776902672718',
        node: document.getElementById('product-component-1710358536734'),
        moneyFormat: '%C2%A3%7B%7Bamount%7D%7D',
        options: {
  "product": {
    "styles": {
